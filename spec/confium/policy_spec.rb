...
RSpec.describe Confium::Policy do
  ...
  describe '.jurisdiction' do
    ...
    it 'rejects unknown jurisdiction' do
      ...
      end.to raise_error(ArgumentError, /unknown jurisdiction/)
    end
  ...
  describe '.check!' do
    ...
    it 'raises PolicyViolationError for EU with RSA-1024' do
      ...
      end.to raise_error(Confium::PolicyViolationError, /key size 1024 below 2048/)
    end
    ...
    it 'raises PolicyViolationError for FIPS mode with Ed25519' do
      ...
      end.to raise_error(Confium::PolicyViolationError, /not FIPS-approved/)
    end
  end
